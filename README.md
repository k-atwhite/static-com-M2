...
# Bugs!
There are a couple of issues that I recognize and still need to figure out
1. My "share button" in the top left corner of my image. It is not meant to be all white, but I believe there is some sort of CSS rule that is overriding my button design. 
2. I tried to be clever by using an unordered list of the items in my nav bar, and changing the bullet points to icons. Down the road this bit me in the butt because I had trouble editing them to be responsive.
3. Overall design issues: I wanted to try and make my own design choices. But in the process i realized how far from a designer I am. Spacing, color, font choices were all much much harder than I anticipated. And my own creative result looks like something from 1998!
